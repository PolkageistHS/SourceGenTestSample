...
[Generator]
public class SomethingGenerator : IIncrementalGenerator
{
    /// <inheritdoc />
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        IncrementalValuesProvider<string> info = context.SyntaxProvider.ForAttributeWithMetadataName("SourceGenSample.Generator.GenerateSomethingAttribute", 
                                                                                                     static (_, _) => true,
